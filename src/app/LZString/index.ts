...
export const LZString: LZString = (function () {
  ...
  const LZString: LZString = {
    compressToBase64: function (input: string): string {
      if (input == null) return "";
      const res: string = LZString._compress(input, 6, function (a) {
    ...
    decompressFromBase64: function (input): string | null {
      if (input == null) return "";
    ...
    compressToUTF16: function (input: string): string {
      if (input == null) return "";
      return (
    ...
    decompressFromUTF16: function (compressed: string): string | null {
    ...
    compressToUint8Array: function (uncompressed: string): Uint8Array {
    ...
    compressToEncodedURIComponent: function (input: string): string {
      if (input == null) return "";
    ...
    decompressFromEncodedURIComponent: function (input: string): string | null {
      if (input == null) return "";
      if (input == "") return null;
    ...
    _compress: function (uncompressed, bitsPerChar, getCharFromInt): string {
    ...
    decompress: function (compressed: string): string | null {
      if (compressed == null) return "";
      if (compressed == "") return null;
